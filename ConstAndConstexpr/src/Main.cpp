...
// const: meaning roughly " I promise not to change this value."...The compiler
// enforces the promise made by const.... constexpr: meaning roughly "to be
// evaluated at compile time." This is used primarily to specify constants...
