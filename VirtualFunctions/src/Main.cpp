...
float Rectangle::Area() const { return wigth * height; }

float Rectangle::Perimeter() const { return 2 * wigth + 2 * height; }
...
float Circle::Perimeter() const { return 2.f * PI * radius; }
