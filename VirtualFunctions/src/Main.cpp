...
public:
    ...
    // Append the declarations with = 0 to specify PURE virtual functions (otherwise you'll get REGULAR virtual functions)

    // Regular virtual (virtual float Area() const;): "Derived classes can override this"
    // Pure virtual (virtual float Area() const = 0;): "Derived classes must override this"
